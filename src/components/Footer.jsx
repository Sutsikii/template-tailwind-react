...
export const Footer = () => {
  return (
    <footer class="bg-gray-900 fixed bottom-0 left-0 w-screen">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
        </div>
        <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://nicolas-dutertre.com" class="hover:underline">Sutsiki™</a>. All Rights Reserved.
            </span>
